...
import io.github.runassudo.launchert.LauncherProvider.SqlArguments;
import io.github.runassudo.launchert.LauncherProvider.WorkspaceLoader;
...
public class AutoInstallsLayout implements WorkspaceLoader {
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/io.github.runassudo.launchert", attribute);
        if (value == null) {
